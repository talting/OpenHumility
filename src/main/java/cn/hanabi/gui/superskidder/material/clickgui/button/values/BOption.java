...
public class BOption extends Button {
   ...
   public void draw(float mouseX, float mouseY) {
      ...
      if (((Boolean)this.v.getValue()).booleanValue()) {
         RenderUtil.drawRect(this.x, this.y + 1.0F, this.x + 20.0F, this.y + 9.0F, ColorUtils.lighter(Main.clientColor, 0.30000001192092896D).getRGB());
   ...
   public void mouseClicked(float mouseX, float mouseY) {
      ...
      if (Main.isHovered(this.x, this.y, this.x + 20.0F, this.y + 10.0F, mouseX, mouseY)) {
         this.v.setValueState(Boolean.valueOf(!((Boolean)this.v.getValue()).booleanValue()));
      }
