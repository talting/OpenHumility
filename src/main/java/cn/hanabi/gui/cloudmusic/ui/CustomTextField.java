   ...
   public void keyPressed(int key) {
      ...
      if (this.isFocused) {
         ...
         case 205:
            ...
            float width2 = (float)(Hanabi.INSTANCE.fontManager.wqy13.getStringWidth(this.textString.substring(0, this.selectedChar)) + 2);
            float barOffset2 = width2 - this.offset;
            if (barOffset2 > 111.0F) {
               this.offset += barOffset2 - 111.0F;
            }
         ...
         case 207:
            this.selectedChar = this.textString.length();
            float width3 = (float)(Hanabi.INSTANCE.fontManager.wqy13.getStringWidth(this.textString.substring(0, this.selectedChar)) + 2);
            float barOffset3 = width3 - this.offset;
            if (barOffset3 > 111.0F) {
               this.offset += barOffset3 - 111.0F;
            }
         ...
         case 210:
            ...
            this.selectedChar = this.textString.length();
            float width4 = (float)(Hanabi.INSTANCE.fontManager.wqy13.getStringWidth(this.textString.substring(0, this.selectedChar)) + 2);
            float barOffset4 = width4 - this.offset;
            if (barOffset4 > 111.0F) {
               this.offset += barOffset4 - 111.0F;
            }
         }
      }
