...
public class MusicPlayerUI extends GuiScreen {
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      if (MusicManager.INSTANCE.loadingThread != null) {
         ...
         RenderUtil.drawRoundedRect(this.x + 10.0F, this.y + this.height - 50.0F, this.x + 10.0F + 1.3F * progress, this.y + this.height - 46.0F, 1.4F, Color.WHITE.getRGB());
         RenderUtil.circle(this.x + 10.0F + 1.3F * progress, this.y + this.height - 48.0F, 3.0F, (new Color(255, 255, 255)).getRGB());
         RenderUtil.circle(this.x + 10.0F + 1.3F * progress, this.y + this.height - 48.0F, 2.0F, (new Color(50, 176, 255, 255)).getRGB());
      }
