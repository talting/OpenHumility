...
public class MusicManager {
   ...
   public MusicManager() {
      ...
      this.circleImage = new File(Minecraft.getMinecraft().mcDataDir.toString() + File.separator + "Humility" + File.separator + "circleImage");
      ...
      if (!this.circleLocations.containsKey(Long.valueOf(track.id))) {
         try {
            ...
            IImageBuffer iib2 = new IImageBuffer() {
               ...
               public void skinAvailable() {
                  MusicManager.this.circleLocations.put(Long.valueOf(track.id), rl2);
               }
            };
   ...
   public void makeCirclePicture(Track track, int wid, String path) {
      try {
         ...
         int border = 0;
         Double shape = new Double((double)border, (double)border, (double)(wid - border * 2), (double)(wid - border * 2));
