      ...
      if (this.programmId == -1) {
         ...
         try {
            if (this.vertexShaderId == -1) {
               InputStream in = this.getClass().getResourceAsStream(this.vertexShaderFileName);
            ...
            if (this.fragmentShaderId == -1) {
               InputStream in = this.getClass().getResourceAsStream("fragment/" + this.fragmenShaderFileName);
