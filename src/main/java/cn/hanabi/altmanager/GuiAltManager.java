...
public class GuiAltManager extends GuiScreen {
   ...
   double anim_add = 0.0D;
   double anim_import = 0.0D;
   double anim_confirm = 0.0D;
   double anim1 = 0.0D;
   double anim2 = 0.0D;
   double anim3 = 0.0D;
      ...
      case 14:
         (new Thread("Ban Check") {
            public void run() {
               ...
               for(Alt alt : GuiAltManager.this.getAlts()) {
   ...
   public void drawEditAndAdd(int mouseX, int mouseY) {
      ...
      if (this.isRectHovered((float)this.width / 2.0F + 18.0F, 90.0F, (float)this.width / 2.0F + 42.0F, 120.0F, mouseX, mouseY)) {
         this.anim_add = RenderUtil.getAnimationStateSmooth(2.0D, this.anim_add, (double)(10.0F / (float)Minecraft.getDebugFPS()));
         hoverStringAdd = "Add";
      } else {
         this.anim_add = RenderUtil.getAnimationStateSmooth(0.0D, this.anim_add, (double)(10.0F / (float)Minecraft.getDebugFPS()));
      }

      RenderUtil.drawRect((float)this.width / 2.0F + 18.0F, (float)(125.0D - this.anim_add), (float)this.width / 2.0F + 42.0F, 125.0F, (new Color(47, 116, 253, 255)).getRGB());
      ...
      if (this.isRectHovered((float)this.width / 2.0F + 48.0F, 90.0F, (float)this.width / 2.0F + 78.0F, 120.0F, mouseX, mouseY)) {
         this.anim_import = RenderUtil.getAnimationStateSmooth(2.0D, this.anim_import, (double)(10.0F / (float)Minecraft.getDebugFPS()));
         hoverStringAdd = "Import from clipboard";
      } else {
         this.anim_import = RenderUtil.getAnimationStateSmooth(0.0D, this.anim_import, (double)(10.0F / (float)Minecraft.getDebugFPS()));
      }

      RenderUtil.drawRect((float)this.width / 2.0F + 48.0F, (float)(125.0D - this.anim_import), (float)this.width / 2.0F + 78.0F, 125.0F, (new Color(47, 116, 253, 255)).getRGB());
      ...
      if (this.isRectHovered((float)this.width / 2.0F + 18.0F, 180.0F, (float)this.width / 2.0F + 43.0F, 210.0F, mouseX, mouseY)) {
         this.anim_confirm = RenderUtil.getAnimationStateSmooth(2.0D, this.anim_confirm, (double)(10.0F / (float)Minecraft.getDebugFPS()));
         hoverStringEdit = "Confirm";
      } else {
         this.anim_confirm = RenderUtil.getAnimationStateSmooth(0.0D, this.anim_confirm, (double)(10.0F / (float)Minecraft.getDebugFPS()));
      }

      RenderUtil.drawRect((float)this.width / 2.0F + 18.0F, (float)(200.0D - this.anim_confirm), (float)this.width / 2.0F + 43.0F, 200.0F, (new Color(47, 116, 253, 255)).getRGB());
   ...
   public void drawHeader(int mouseX, int mouseY) {
      ...
      if (this.isRectHovered(63.0F, 50.0F, 87.0F, 73.0F, mouseX, mouseY)) {
         this.anim1 = RenderUtil.getAnimationStateSmooth(2.0D, this.anim1, (double)(10.0F / (float)Minecraft.getDebugFPS()));
         hovering = "Login";
      } else {
         this.anim1 = RenderUtil.getAnimationStateSmooth(0.0D, this.anim1, (double)(10.0F / (float)Minecraft.getDebugFPS()));
      }

      RenderUtil.drawRect(63.0F, (float)(73.0D - this.anim1), 87.0F, 73.0F, (new Color(47, 116, 253, 255)).getRGB());
      ...
      if (this.isRectHovered(95.0F, 50.0F, 115.0F, 73.0F, mouseX, mouseY)) {
         this.anim2 = RenderUtil.getAnimationStateSmooth(2.0D, this.anim2, (double)(10.0F / (float)Minecraft.getDebugFPS()));
         hovering = "Remove";
      } else {
         this.anim2 = RenderUtil.getAnimationStateSmooth(0.0D, this.anim2, (double)(10.0F / (float)Minecraft.getDebugFPS()));
      }

      RenderUtil.drawRect(95.0F, (float)(73.0D - this.anim2), 120.0F, 73.0F, (new Color(47, 116, 253, 255)).getRGB());
      ...
      for(Alt alt : this.getAlts()) {
         if (this.isAltInArea(y)) {
            ...
            if (alt.getPassword().equals("")) {
               ...
               String pass = alt.getPassword().replaceAll("\\.", "*");
            }
   ...
   protected void mouseClicked(int par1, int par2, int par3) {
      ...
      if (this.isRectHovered((float)this.width / 2.0F + 18.0F, 90.0F, (float)this.width / 2.0F + 42.0F, 120.0F, par1, par2)) {
         AddAltThread login = new AddAltThread(this.add_UserNameField.getText(), this.add_PassWordField.getText());
         login.start();
   ...
   private List<Alt> getAlts() {
      ...
      for(Alt alt : AltManager.registry) {
         if (this.seatchField.getText().isEmpty() || alt.getMask().toLowerCase().contains(this.seatchField.getText().toLowerCase()) || alt.getUsername().toLowerCase().contains(this.seatchField.getText().toLowerCase())) {
            altList.add(alt);
         }
      }
