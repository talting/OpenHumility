...
public class AutoHeal extends Mod {
   ...
   public Value potHealthValue = new Value("AutoHeal", "Pot Health", 15.0D, 3.0D, 20.0D, 1.0D);
   ...
   public void onUpdate(EventPreMotion event) {
      ...
      if (this.timer.isDelayComplete(1000L) && KillAura.target == null) {
         ...
         if (!mc.thePlayer.isPotionActive(regenId) && !this.potting && mc.thePlayer.onGround && ((Boolean)this.healthValue.getValue()).booleanValue() && (double)mc.thePlayer.getHealth() <= ((Double)this.potHealthValue.getValue()).doubleValue() && this.hasPot(regenId)) {
         ...
         if (!mc.thePlayer.isPotionActive(speedId) && !this.potting && mc.thePlayer.onGround && ((Boolean)this.speedValue.getValue()).booleanValue() && this.hasPot(speedId)) {
         ...
         if (this.potting) {
            ...
            mc.thePlayer.motionY = 0.051011199999D;
