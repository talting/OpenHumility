...
public class AutoMLG extends Mod {
   public Value delay = new Value("Auto MLG", "Delay", 100.0D, 1.0D, 1000.0D, 50.0D);
   boolean tick;
   ...
   private void placeWater(BlockPos pos, EnumFacing facing) {
      ...
      mc.playerController.onPlayerRightClick(mc.thePlayer, mc.theWorld, mc.thePlayer.inventory.getCurrentItem(), pos, facing, new Vec3((double)pos.getX() + 0.5D, (double)pos.getY() + 1.0D, (double)pos.getZ() + 0.5D));
      if (heldItem != null) {
