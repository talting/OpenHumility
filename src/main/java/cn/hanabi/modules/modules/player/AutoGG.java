...
public class AutoGG extends Mod {
   ...
   public Value delay = new Value("AutoGG", "Speak Delay", 100.0D, 100.0D, 3000.0D, 100.0D);
      ...
      if (mc.thePlayer != null) {
         ...
         if (this.needSpeak) {
            if (!this.speaked && this.timer.isDelayComplete((Double)this.delay.getValueState())) {
               ...
               if (((Boolean)this.sceenshot.getValueState()).booleanValue()) {
            ...
            if (this.speaked && this.timer.isDelayComplete(Double.valueOf(((Double)autoPlay.delay.getValueState()).doubleValue() + ((Double)this.delay.getValueState()).doubleValue()))) {
               this.speaked = false;
