...
public class Fly extends Mod {
   ...
   public static Value timer = new Value("Fly", "Motion Speed", 1.0D, 1.0D, 10.0D, 1.0D);
   ...
   public static void damagePlayer(int damage) {
      ...
      double i1 = getRandomInRange(0.059D, 0.0615D);
      double i2 = getRandomInRange(0.049D, 0.0625D);
      double i3 = getRandomInRange(5.0E-7D, 7.0E-7D);
   ...
   public void onPullback(EventPullback e) {
      if (((Boolean)this.lagback.getValueState()).booleanValue() && !this.mode.isCurrentMode("Disabler")) {
         lagbacktimer.reset();
