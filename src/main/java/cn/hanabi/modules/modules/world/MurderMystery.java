...
public class MurderMystery extends Mod {
   ...
   public void onRender(EventRender event) {
      if (isMurder(murder)) {
         ((ESP)ModManager.getModule(ESP.class)).renderBox(murder, murder.hurtTime > 1 ? 0.800000011920929D : 0.0D, murder.hurtTime > 1 ? 0.0D : 0.4000000059604645D, murder.hurtTime > 1 ? 0.0D : 1.0D);
      }
