...
public class Waypoints extends Mod {
   ...
   public static Value radius = new Value("WayPoints", "Ranius", 30.0D, 10.0D, 500.0D, 10.0D);
   ...
   public void onRenderGui(EventRender2D eventRenderGui) {
      if (mc.getCurrentServerData() != null) {
         ...
         for(Waypoint waypoint : waypointMap.keySet()) {
            ...
            } else if (((Boolean)this.arrows.getValue()).booleanValue() && Objects.equals(waypoint.getAddress(), mc.getCurrentServerData().serverIP)) {
