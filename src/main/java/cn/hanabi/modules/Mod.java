...
public abstract class Mod {
   ...
   public void onRenderArray() {
      ...
      if (this.posYRend != 0.0F) {
         this.posYRend = (float)RenderUtil.getAnimationStateSmooth(0.0D, (double)this.posYRend, (double)(16.0F / (float)Minecraft.getDebugFPS()));
      }
      ...
      if (this.isEnabled()) {
         ...
         this.posX = (float)RenderUtil.getAnimationStateSmooth(-15.0D, (double)this.posX, (double)(16.0F / (float)Minecraft.getDebugFPS()));
      }
