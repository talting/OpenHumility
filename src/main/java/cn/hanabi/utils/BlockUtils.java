...
public class BlockUtils {
   ...
   public static boolean stairCollision() {
      return getBlockAtPosC(Wrapper.mc.thePlayer, 0.3100000023841858D, 0.0D, 0.3100000023841858D) instanceof BlockStairs || getBlockAtPosC(Wrapper.mc.thePlayer, -0.3100000023841858D, 0.0D, -0.3100000023841858D) instanceof BlockStairs || getBlockAtPosC(Wrapper.mc.thePlayer, 0.3100000023841858D, 0.0D, -0.3100000023841858D) instanceof BlockStairs || getBlockAtPosC(Wrapper.mc.thePlayer, -0.3100000023841858D, 0.0D, 0.3100000023841858D) instanceof BlockStairs || getBlockatPosSpeed(Wrapper.mc.thePlayer, 1.05F, 1.05F) instanceof BlockStairs;
   }
   ...
   public static double getDistanceToFall() {
      ...
      for(double i = Wrapper.mc.thePlayer.posY; i > 0.0D; --i) {
      ...
      return Wrapper.mc.thePlayer.posY - distance - 1.0D;
   }
   ...
   public static boolean isOnLiquidFull() {
      ...
      if (getBlockAtPosC(Wrapper.mc.thePlayer, 0.30000001192092896D, 0.10000000149011612D, 0.30000001192092896D).getMaterial().isLiquid() && getBlockAtPosC(Wrapper.mc.thePlayer, -0.30000001192092896D, 0.10000000149011612D, -0.30000001192092896D).getMaterial().isLiquid() && ((Integer)Wrapper.mc.theWorld.getBlockState(new BlockPos(Wrapper.mc.thePlayer.posX - 0.3D, Wrapper.mc.thePlayer.posY - 0.1D, Wrapper.mc.thePlayer.posZ - 0.3D)).getValue(BlockLiquid.LEVEL)).intValue() == 0 && ((Integer)Wrapper.mc.theWorld.getBlockState(new BlockPos(Wrapper.mc.thePlayer.posX + 0.3D, Wrapper.mc.thePlayer.posY - 0.1D, Wrapper.mc.thePlayer.posZ + 0.3D)).getValue(BlockLiquid.LEVEL)).intValue() == 0) {
         onLiquid = true;
      }
   ...
   public static boolean isOnLiquid() {
      AxisAlignedBB axisAlignedBB = Minecraft.getMinecraft().thePlayer.getEntityBoundingBox().offset(0.0D, -0.1D, 0.0D).contract(0.001D, 0.0D, 0.001D);
      int xMin = MathHelper.floor_double(axisAlignedBB.minX);
      int xMax = MathHelper.floor_double(axisAlignedBB.maxX + 1.0D);
      int yMin = MathHelper.floor_double(axisAlignedBB.minY);
      int yMax = MathHelper.floor_double(axisAlignedBB.maxY + 1.0D);
      int zMin = MathHelper.floor_double(axisAlignedBB.minZ);
      int zMax = MathHelper.floor_double(axisAlignedBB.maxZ + 1.0D);
   ...
   public static boolean isOnLadder() {
      ...
      int y = (int)Wrapper.mc.thePlayer.getEntityBoundingBox().offset(0.0D, 1.0D, 0.0D).minY;
   ...
   public static float[] getBlockRotations(double x, double y, double z) {
      double var4 = x - Wrapper.mc.thePlayer.posX + 0.5D;
      double var6 = z - Wrapper.mc.thePlayer.posZ + 0.5D;
      double var8 = y - (Wrapper.mc.thePlayer.posY + (double)Wrapper.mc.thePlayer.getEyeHeight() - 1.0D);
