...
public final class BlockUtils {
   ...
   public static boolean collideBlock(AxisAlignedBB axisAlignedBB, BlockUtils.Collidable collide) {
   ...
   public static boolean collideBlockIntersects(AxisAlignedBB axisAlignedBB, BlockUtils.Collidable collide) {
      EntityPlayerSP var10000 = mc.thePlayer;
      int x = MathHelper.floor_double(var10000.getEntityBoundingBox().minX);
      var10000 = mc.thePlayer;
