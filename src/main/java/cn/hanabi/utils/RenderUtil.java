...
public class RenderUtil {
   ...
   public static int getRainbow(int speed, int offset, double rainSpeed, double rainOffset, float saturation, float brightness) {
      float hue = (float)(((double)System.currentTimeMillis() * rainSpeed + (double)offset / rainOffset) % (double)speed * 2.0D);
      hue = hue / (float)speed;
   ...
   public static double getAnimationState1(double animation, double finalState, double speed) {
      if (animation != finalState && speed != 0.0D) {
         double minSpeed = speed / 6.0D;
         double maxSpeed = speed * 2.5D;
         double sp33d = Math.pow(Math.abs(finalState - animation), 1.2D) * 1.8D;
   ...
   public static void drawLoadingCircle() {
      float status = (float)((double)System.currentTimeMillis() * 0.1D % 400.0D);
      float size = 0.5F;
   ...
   public static void drawCircle(float xx, float yy, float radius, Color col, float width, float position, float round) {
      ...
      for(int i = (int)position; (float)i < position + (float)sections; ++i) {
      ...
      for(int var17 = (int)(position + (float)sections); var17 > (int)position; --var17) {
         x = (float)((double)radius * Math.cos((double)var17 * dAngle));
         y = (float)((double)radius * Math.sin((double)var17 * dAngle));
         GL11.glColor4f((float)col.getRed() / 255.0F, (float)col.getGreen() / 255.0F, (float)col.getBlue() / 255.0F, (float)col.getAlpha() / 255.0F);
         GL11.glVertex2f(xx + x, yy + y);
      }
   ...
   public static void drawCircle(double radius, double x, double lastTickX, double y, double lastTickY, double z, double lastTickZ, Color c) {
      ...
      for(int a = 0; a < 360; ++a) {
         ...
         wr.pos(posX + Math.cos(rad) * radius, posY + 0.20000000298023224D, posZ + Math.sin(rad) * radius).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
      }
   ...
   public static void drawRoundedRect(float x, float y, float x2, float y2, float round, int color) {
      x = (float)((double)x + (double)(round / 2.0F) + 0.5D);
      y = (float)((double)y + (double)(round / 2.0F) + 0.5D);
      x2 = (float)((double)x2 - ((double)(round / 2.0F) + 0.5D));
      y2 = (float)((double)y2 - ((double)(round / 2.0F) + 0.5D));
   ...
   public static void drawRoundedRect2(float n, float n2, float n3, float n4, int n5, int n6) {
      ...
      float var7;
      float var9;
      drawVLine(var6 = n * 2.0F, (var7 = n2 * 2.0F) + 1.0F, (var9 = n4 * 2.0F) - 2.0F, n5);
      float var8;
      drawVLine((var8 = n3 * 2.0F) - 1.0F, var7 + 1.0F, var9 - 2.0F, n5);
      drawHLine(var6 + 2.0F, var8 - 3.0F, var7, n5);
      drawHLine(var6 + 2.0F, var8 - 3.0F, var9 - 1.0F, n5);
      drawHLine(var6 + 1.0F, var6 + 1.0F, var7 + 1.0F, n5);
      drawHLine(var8 - 2.0F, var8 - 2.0F, var7 + 1.0F, n5);
      drawHLine(var8 - 2.0F, var8 - 2.0F, var9 - 2.0F, n5);
      drawHLine(var6 + 1.0F, var6 + 1.0F, var9 - 2.0F, n5);
      drawRect(var6 + 1.0F, var7 + 1.0F, var8 - 1.0F, var9 - 1.0F, n6);
      GL11.glScalef(2.0F, 2.0F, 2.0F);
      GL11.glEnable(3553);
      GL11.glDisable(3042);
      GL11.glEnable(2929);
   ...
   public static void drawCircle(float x, float y, float radius, int startPi, int endPi, int c) {
      ...
      for(double i = (double)startPi; i < (double)endPi; ++i) {
         ...
         render.pos((double)x + outer[2], (double)y + outer[3], 0.0D).endVertex();
         render.pos((double)x + outer[0], (double)y + outer[1], 0.0D).endVertex();
         render.pos((double)x, (double)y, 0.0D).endVertex();
         tess.draw();
      }
   ...
   public static void drawFastRoundedRect(float x0, float y0, float x1, float y1, float radius, int color) {
      ...
      for(int var22 = 0; var22 <= 18; ++var22) {
         float f8 = (float)var22 * 5.0F;
         GL11.glVertex2f((float)((double)f6 + (double)radius * Math.cos(Math.toRadians((double)f8))), (float)((double)f7 - (double)radius * Math.sin(Math.toRadians((double)f8))));
      }
      ...
      for(int var23 = 0; var23 <= 18; ++var23) {
         float f9 = (float)var23 * 5.0F;
         GL11.glVertex2f((float)((double)f6 - (double)radius * Math.cos(Math.toRadians((double)f9))), (float)((double)f7 - (double)radius * Math.sin(Math.toRadians((double)f9))));
      }
      ...
      for(int var24 = 0; var24 <= 18; ++var24) {
         float f10 = (float)var24 * 5.0F;
         GL11.glVertex2f((float)((double)f6 - (double)radius * Math.cos(Math.toRadians((double)f10))), (float)((double)f7 + (double)radius * Math.sin(Math.toRadians((double)f10))));
      }
   ...
   public void drawCircle(double radius, double x, double y, double z, Color c) {
      ...
      for(int a = 0; a < 360; ++a) {
         double rad = Math.toRadians((double)a);
         wr.pos(x + Math.cos(rad) * radius, y + 0.20000000298023224D, z + Math.sin(rad) * radius).color(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha()).endVertex();
      }
   ...
   public static void drawAWTShape(Shape shape, double epsilon) {
      ...
      case 0:
         tess.gluTessProperty(100140, 100130.0D);
         break;
      case 1:
         tess.gluTessProperty(100140, 100131.0D);
      }
      ...
      for(; !path.isDone(); path.next()) {
         ...
         case 2:
            ...
            break;
         case 3:
            Double[][] points2 = MathUtils.getPointsOnCurve(new Double[][]{{cp[0], cp[1]}, {segment[0], segment[1]}, {segment[2], segment[3]}, {segment[4], segment[5]}}, 10);
            pointsCache.addAll(Arrays.asList(points2));
            cp[0] = segment[4];
            cp[1] = segment[5];
            break;
         case 4:
            for(Double[] point : MathUtils.simplifyPoints((Double[][])pointsCache.toArray(new Double[0][0]), epsilon)) {
               tessVertex(tess, new double[]{point[0].doubleValue(), point[1].doubleValue(), 0.0D, 0.0D, 0.0D, 0.0D});
            }
