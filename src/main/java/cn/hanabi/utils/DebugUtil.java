...
public class DebugUtil {
   ...
   public DebugUtil.FadeState fadeState = DebugUtil.FadeState.IN;
   public DebugUtil.Type type;

   public DebugUtil(String Message, int Timer, DebugUtil.Type Type) {
      super();
   ...
   public void onRender() {
      this.Position.translate(this.positionX, 0.0F, 5.0D);
      int color = -1;
      switch(this.type) {
      case NONE:
