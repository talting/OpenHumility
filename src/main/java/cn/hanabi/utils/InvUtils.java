...
public class InvUtils {
   ...
   public static double getItemDamage(ItemStack stack) {
      ...
      if (stack.isItemEnchanted()) {
         damage = damage + (double)EnchantmentHelper.getEnchantmentLevel(Enchantment.fireAspect.effectId, stack);
         damage = damage + (double)EnchantmentHelper.getEnchantmentLevel(Enchantment.sharpness.effectId, stack) * 1.25D;
      }
