...
public class Hanabi {
   @NotNull
   public static final String CLIENT_NAME = "Humility";
   public static final double CLIENT_VERSION_NUMBER = 3.30227D;
   @NotNull
   public static final String CLIENT_VERSION = "3.30227";
   @NotNull
   ...
   public void log(String message) {
      String prefix = "[Humility] ";
      INSTANCE.println(prefix + message);
   }

   public void startClient() {
      Display.setTitle("Humility 3.30227 | 天行健,君子以自强不息");
   ...
   public boolean fastRenderDisabled(GameSettings gameSettingsIn) {
      try {
         return !((Boolean)this.ofFastRenderField.get(gameSettingsIn)).booleanValue();
   ...
   static {
      ...
      for(char c : "Humility".toCharArray()) {
      ...
      for(int i = 0; i < chars.size(); ++i) {
         c[i] = ((Character)chars.get(i)).charValue();
      }
